...
Game::Game():
	...
	score_text("PNG/kenvector_future_thin.ttf", 24, 10, 10, sf::Color::White),
...
void Game::draw() {
	...
	sf::RectangleShape r1(sf::Vector2f(WINDOW_WIDTH, 50));
	r1.setFillColor(sf::Color(107, 142, 35));
	switch (game_state) {
	case INTRO:
		break;
	case PLAY:
